...
La fonction *input(" message ")* est l'équivalent de la commande *SAISIE(" message ")* vu en cours d'algorithmie, attention elle renvoie une chaîne de caractère.

[source,python]
----
value = input ("Veuillez saisir un texte ou une valeur")
print( value)
----
...
[source,python]
----
value = int(input ("Veuillez saisir un texte ou une valeur"))
print( value)
----
...
choixJoueur = input("Pierre Papier Ciseaux ? ")
